...
if __name__ == "__main__":
    ...
    # Referenciamos al fichero service account:
    os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = 'bootcamp-cloud-thebridge-7d26f7b1505a.json' # TODO: Usa tu service account

    # TODO: replace with your project ID
    project_id = "bootcamp-cloud-thebridge"
    # TODO: Replace with the ID of your member in the form 'user:member@example.com'.
    member = ["user:nacho.soto@thebridgeschool.es"]
    for m in member:
